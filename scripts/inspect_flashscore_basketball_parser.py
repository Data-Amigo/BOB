"""Inspect the Flashscore basketball parser output."""
...
from ganji_mtaani_agent.parsers.flashscore import parse_flashscore_basketball
...
def main() -> None:
    """Fetch the Flashscore basketball page and inspect parsed rows."""

    parser = argparse.ArgumentParser(description="Inspect the Flashscore basketball parser output.")
    ...
    parsed_rows = parse_flashscore_basketball(result.html)
