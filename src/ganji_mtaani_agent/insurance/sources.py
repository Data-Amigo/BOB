...
INSURANCE_SOURCES: dict[str, InsuranceSourceConfig] = {
    ...
    "jubilee": InsuranceSourceConfig(
        ...
        base_url="https://www.jubilee-insurance.com",
        default_target="health",
        description="One of Kenya's largest insurers. Products span health, life, motor, travel, and general lines.",
        ...
        targets={
            "health": InsuranceSourceTarget(
                ...
                url="https://www.jubilee-insurance.com/ke/individual/health",
                category="health",
            ...
            "life": InsuranceSourceTarget(
                ...
                url="https://www.jubilee-insurance.com/ke/individual/life",
                category="life",
                description="Jubilee life insurance and savings-linked life products.",
            ),
            "motor": InsuranceSourceTarget(
                name="motor",
                display_name="Motor Insurance",
                url="https://www.jubilee-insurance.com/ke/individual/general/motor",
                category="motor",
                description="Jubilee motor insurance — comprehensive and third-party covers.",
            ),
            "travel": InsuranceSourceTarget(
                name="travel",
                display_name="Travel Insurance",
                url="https://www.jubilee-insurance.com/ke/individual/general/travel",
                category="travel",
                description="Jubilee travel insurance for domestic and international trips.",
            ),
            "personal_accident": InsuranceSourceTarget(
                name="personal_accident",
                display_name="Personal Accident",
                url="https://www.jubilee-insurance.com/ke/individual/general/personal-accident",
                category="personal_accident",
                description="Jubilee personal accident covers for individuals and families.",
            ),
        },
    ),
